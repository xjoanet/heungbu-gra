export const LANG = {
  ko: {
    ...
    guide3t: '등록 방법: MCP 클라이언트 설정(예: ~/.claude/CLAUDE.md 또는 설정 화면)에 "command": "npx", "args": ["-y", "heungbu26-mcp"] 항목을 추가하면 됩니다. 매번 붙여넣지 않아도 모든 채팅에서 자동으로 작동해요.',
  ...
  en: {
    ...
    guide3t: 'How: in your MCP client config (e.g. ~/.claude/mcp.json or settings), add "command": "npx", "args": ["-y", "heungbu26-mcp"]. It then runs in every chat automatically.',
