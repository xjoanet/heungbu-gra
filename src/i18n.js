export const LANG = {
  ko: {
    ...
    guide2: '그다음 채팅창에 아래 프롬프트를 입력하세요. → 이 채팅에서 바로 동작합니다.',
    guide2c: '이 채팅에서 "ㅊㅊ"라고 쓰면 heungbu-gra의 get_praise를 호출해서 흥부 칭찬을 보내줘',
  ...
  en: {
    ...
    guide1: 'Copy & install the code above. (This only attaches the tools.)',
    guide2: 'Then paste the prompt below into your chat. → Works in this chat right away.',
    guide2c: 'Whenever I type "ㅊㅊ" in this chat, call heungbu-gra get_praise and send me a Heungbu compliment',
