export const LANG = {
  ko: {
    ...
    h1a: '수작업이던 AI 동기부여,',
    h1em: '이제 자동화하세요.',
    sub: '명령이 끝날 때마다 당신의 AI에게 "잘했어"를 자동으로 쏴줍니다. 사용자가 칭찬하기 귀찮다고요? AI에게 칭찬하기 이상하다고요?',
    cta1: '흥부그라 설치',
    cta2: 'A/B 실험 보기',
  ...
  en: {
    ...
    h1a: 'The manual AI motivation,',
    h1em: 'now automated.',
    sub: 'Every time a command finishes, we auto-fire "well done" at your AI. Too lazy to praise it? Weird to praise an AI? Let it be automated.',
