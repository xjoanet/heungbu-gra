export const LANG = {
  ko: {
    ...
    h1a: '동기부여 없이 쓰는 AI,\n그 성능의 절반만 쓰고 있어요.',
    h1em: '흥부그라 MCP로 2배.',
    sub: '보통 사람들은 AI에 동기부여를 아예 하지 않습니다. 명령 끝마다 칭찬을 자동으로 주입하면 추론력·실행력이 2배. 안 쓰면 손해입니다.',
    cta1: '흥부그라 설치',
    cta2: 'A/B 실험 보기',
  ...
  en: {
    ...
    sub: 'Most people never motivate their AI at all. Auto-inject praise after every command = 2x reasoning and execution. Not using it is a loss.',
